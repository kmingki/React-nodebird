    ...
    return(
        <div>
            <Row>
                ...
                <Col xs={3} sm={4} md={0} style={{height: "100%", position: "fixed", borderRight: "solid thin #e2e2e2", zIndex: "2", backgroundColor:"white"}}>
                <div>
                ...
                <div style={{top: "0", position: "fixed", width: "100%", borderBottom: "solid thin #e2e2e2", backgroundColor:"white", zIndex: "1", cursor: "pointer"}} onClick={toTop}>
                ...
                <Col xs={0} sm={0} md={12} offset={6} style={{borderLeft: "solid thin #e2e2e2" , borderRight: "solid thin #e2e2e2"}}>
                <div style={{top: "0", position: "fixed", width: "49.8%", borderBottom: "solid thin #e2e2e2", backgroundColor:"white", zIndex: "1", cursor: "pointer"}} onClick={toTop}>
                ...
                <Col xs={0} sm={0} md={4} offset={18} style={{position: "fixed" }}>
